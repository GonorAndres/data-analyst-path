...
export function KPICard({ label, value, prefix = '', suffix = '', decimals = 0, delay = 0 }: KPICardProps) {
  ...
  return (
    ...
    >
      <span
        ref={ref}
        className="font-serif text-2xl md:text-3xl leading-none tabular-nums text-ink"
      >
        {value == null || !Number.isFinite(value) ? '—' : `${prefix}${value.toFixed(decimals)}${suffix}`}
      </span>
