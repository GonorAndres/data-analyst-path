...
import { useOpsGeographic } from '@/features/operations/hooks/useOpsAPI'
...
import { ChoroplethMap } from '@/features/operations/components/d3/ChoroplethMap'
    ...
    <FeatureText><div className="space-y-4">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <ChartContainer
          ...
          subtitle="Esquema de municipios; selecciona uno para filtrar."
        >
          {mapData.length > 0 ? (
            <ChoroplethMap
              data={mapData}
                ...
                <tbody>
                  {boroughs.map((row) => (
                    ...
                    >
                      ...
                      <td className="font-mono text-ops-text text-right py-2 pr-3 tabular-nums">
                        {row.avg_resolution_days == null ? '—' : row.avg_resolution_days.toFixed(1)}
                      </td>
                      <td
