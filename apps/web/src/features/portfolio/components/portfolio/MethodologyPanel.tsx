...
export function MethodologyPanel() {
  ...
  return (
    <FeatureText><div>
      ...
      {/* Notebook content */}
      <p className="text-xs text-muted mb-4">{t('Source notebooks retain their original language and formatting.', 'Los notebooks fuente conservan su idioma y formato originales.')}</p>
      {loading ? (
