...
# -- Insight box --
champion_seg = rfm_raw[rfm_raw["segment"].str.contains("Alto Valor", case=False, na=False)]
if len(champion_seg) > 0:
    ...
    finding = (
        f"<ul>"
        f"<li>Los 'Alto Valor' representan solo el <strong>{champ_pct:.1f}%</strong> de la base "
