...
export function PageHeader({
  ...
  return (
    <header className="space-y-2">
      <p className="font-sans text-xs tracking-widest uppercase text-muted">{eyebrow}</p>
      <h1 className="font-serif text-3xl md:text-4xl leading-tight">{title}</h1>
      <p className="font-sans text-base text-muted max-w-2xl leading-relaxed">{lede}</p>
    </header>
  )
}
