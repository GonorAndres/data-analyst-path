...
export const metadata: Metadata = {
  title: 'Análisis de Cohortes — Olist E-Commerce',
  description:
    'Retención por cohortes, segmentación RFM y valor de vida del cliente sobre 96,478 pedidos del marketplace brasileño Olist.',
  icons: { icon: '/cohorts/favicon.svg' },
  openGraph: {
    title: 'Análisis de Cohortes — Olist E-Commerce',
    description:
      'Por qué sólo el 3% de los clientes vuelve a comprar: retención, segmentos y LTV.',
    type: 'website',
  },
}
